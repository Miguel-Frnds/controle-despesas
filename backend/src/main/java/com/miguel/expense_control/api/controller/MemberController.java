...
public class MemberController {
    ...
    @GetMapping()
    public ResponseEntity<List<MemberResponseDTO>> findMembers(@RequestParam(required = false) Boolean active){
        List<MemberResponseDTO> members = memberService.findMembers(active);
